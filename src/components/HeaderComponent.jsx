          ...
          <div className="flex flex-row items-center justify-end gap-2">
            ...
            <div className={`${comprobarAutenticado() ? "hidden" : ""}`}>
              ...
              >
                ...
                <div
                  className="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-[15rem] z-30 bg-white shadow-md rounded-lg p-2 dark:bg-gray-800 dark:border dark:border-gray-700"
